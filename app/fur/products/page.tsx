export const metadata = {
  title:
    'Fur - Jos. H. Lowenstein & Sons - Leather Products, Hair Products & Fur Products - Dye Products and Dyestuff - JHL',
  keywords:
...
import Hero from '@/components/fur/hero-fur-prod'

import ProdTabs from '@/components/fur/fur-prods-tabs'
import Mosaic from '@/components/fur/fur-prod-mosaic'
