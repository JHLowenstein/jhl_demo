...
import Hero from '@/components/leather/hero-leather-prod'

import ProdTabs from '@/components/leather/leather-prods-tabs'
import Mosaic from '@/components/leather/leather-prod-mosaic'
