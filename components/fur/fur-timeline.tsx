      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        <div className='py-12 md:py-20'>
          ...
          >
            ...
            >
              <div className='pl-2'>
                <div className=' text-xl text-sky-500 mb-2'></div>
                <div className='flex items-center mb-3'>
                  <div className='absolute left-0 inline-flex text-sm font-semibold py-1 px-3 text-sky-600 bg-sky-200 rounded-full'>
                    1897
                  </div>
                  <div
                    className='absolute left-0 h-full px-px bg-pink-300 ml-20 self-start transform -translate-x-1/2 translate-y-3'
                    aria-hidden='true'
                  ></div>
                  <div
            ...
            >
              <div className='pl-2'>
                ...
                <div className='flex items-center mb-3'>
                  ...
                  <div
                    className='absolute left-0 h-full px-px bg-emerald-300 ml-20 self-start transform -translate-x-1/2 translate-y-3'
                    aria-hidden='true'
                  ></div>
                  <div
                    className='absolute left-0 w-2 h-2 bg-sky-500 border-4 box-content border-snow-900 rounded-full ml-20 transform -translate-x-1/2'
